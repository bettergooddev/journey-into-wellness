  ...
  return (
    <div className="container-large py-16">
      <div className="grid grid-cols-1 gap-x-20 gap-y-12 md:grid-flow-dense md:grid-cols-2">
        <div className={cn('order-1 flex flex-col justify-center', classes.body({ reverse }))}>
        ...
        <div className={cn('order-2 flex flex-col justify-center', classes.graphic({ reverse }))}>
